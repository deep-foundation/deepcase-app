...
export function CytoMenu({
  ...
  const boxShadow = useColorModeValue('#141214', '#90cdf4');
  const switchLabelColor = useColorModeValue('#eeeeee', '#5e5e5e');
  const switchCheck = useColorModeValue('#90cdf4', '#141214');
  ...
  return (<Box 
    ...
    > 
      <Box 
        ...
        sx={{boxShadow: `1px 1px 2px 1px ${boxShadow}`}}
      >
